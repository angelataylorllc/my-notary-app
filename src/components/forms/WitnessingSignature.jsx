// src/components/forms/WitnessingSignature.jsx
...
const WitnessingSignature = () => {
    ...
    return (
        <div className="container p-4 mt-10">
            <h2 className="text-xl font-bold mb-4">Witnessing or Attesting a Signature</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="block">
                    This signature was witnessed before me on <input type="date" name="date" value={formData.date} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                </label>
                <label className="block">
