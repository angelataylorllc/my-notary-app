// src/components/forms/VerificationOath.jsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';

const VerificationOath = () => {
    ...
    return (
        <div className="container p-4 mt-10">
            <h2 className="text-xl font-bold mb-4">Verification on Oath or Affirmation</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <label className="block">
                    This record was verified before me on <input type="date" name="date" value={formData.date} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                </label>
                <label className="block">
...
export default VerificationOath;